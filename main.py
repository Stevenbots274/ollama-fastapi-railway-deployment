...
<head>
    ...
    <style>
        body { font-family: system-ui, sans-serif; max-width: 800px; margin: 40px auto; padding: 20px; line-height: 1.6; background: #f4f4f9; }
...
<body>
    <div class="card">
        ...
        <h3>API Usage</h3>
        <p>Endpoint: <code>POST /v1/chat/completions</code></p>
        <p>Auth: <code>Bearer YOUR_API_KEY</code></p>
    </div>
